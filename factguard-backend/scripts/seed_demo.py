        ...
        "sources": [
            {
                ...
                "tier": 1,
                "relevance": 10,
                "summary": "NASA confirms Earth is an oblate spheroid.",
            ...
            },
            {
                ...
                "tier": 1,
                "relevance": 9,
                "summary": "Flat Earth debunked by satellite imagery.",
                "quote": "Satellite images confirm Earth's curvature.",
            },
        ],
    },
    {
        ...
        "sources": [
            {
                "title": "WHO Statement on Ivermectin",
                "url": "https://who.int",
                "author": "WHO",
                "date": "2025-09-10",
                "stance": "contradicts",
                ...
                "tier": 1,
                "relevance": 10,
                "summary": "WHO recommends against ivermectin for COVID-19.",
                "quote": "Current evidence does not support ivermectin for COVID-19.",
            },
        ],
    },
    {
        ...
        "sources": [
            {
                ...
                "tier": 1,
                "relevance": 10,
                "summary": "CDC confirms no link between vaccines and autism.",
                "quote": "Vaccines do not cause autism.",
            },
            {
                "title": "Lancet Retraction",
                ...
                "tier": 1,
                "relevance": 9,
                "summary": "Original study linking vaccines to autism was retracted.",
                "quote": "Retracted due to fraudulent data.",
            },
        ],
    },
    {
        ...
        "sources": [
            {
                "title": "Kuo: Foldable iPhone in 2026",
                ...
                "tier": 2,
                "relevance": 9,
                "summary": "Analyst Kuo predicts foldable iPhone in 2026.",
                "quote": "Supply chain checks indicate foldable iPhone in 2026.",
            },
        ],
    },
    {
        ...
        "sources": [
            {
                "title": "Tesla Q4 2025 Delivery Report",
                ...
                "tier": 1,
                "relevance": 10,
                "summary": "Tesla reports record deliveries.",
                "quote": "468,000 vehicles delivered in Q4.",
            },
        ],
    },
]
...
FINANCIAL_FIXTURES = [
    {
        ...
        "graph_data": {
            ...
            "change_7d": "-8.3%",
            "data": [
                {"date": f"2026-04-{d:02d}", "price": 0.048 - d * 0.0005} for d in range(1, 25)
            ],
        },
        "analysis": {
            "signal": "WATCH",
        ...
        "sources": [
            {
                "title": "Cloud Pricing Analysis Q2 2026",
    ...
    },
    {
        ...
        "graph_data": {
            ...
            "change_7d": "0%",
            "data": [
                {"date": "2024-06-01", "price": 20},
                {"date": "2025-01-15", "price": 45},
        ...
        "sources": [
            {
                "title": "TechCrunch: Competitor Raises $100M",
...
THREAT_FIXTURES = [
    {
        ...
        "sources": [
            {
                "title": "KrebsOnSecurity: Vendor Breach",
    ...
    },
    {
        ...
        "sources": [
            {
                "title": "Reuters: Disinformation Campaign",
    ...
    },
    {
        ...
        "sources": [
            {
                "title": "BleepingComputer: Scam Surge",
    ...
    },
    {
        ...
        "analysis": {
            "best_deal": {
                "platform": "Best Buy",
                "price": "$1099",
                "why": "Best price from authorized retailer",
            },
            "verdict": "Shop Around",
    ...
    },
    {
        ...
        "analysis": {
            "best_deal": {
                "platform": "Amazon",
                "price": "$349",
                "why": "Lowest price with free shipping",
            },
            "verdict": "Buy Now",
