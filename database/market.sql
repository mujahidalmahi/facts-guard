...
-- Price comparison tables for the market section. Safe to re-run.
-- ============================================================

-- Shared trigger function (safe to re-run standalone)
...
DROP TRIGGER IF EXISTS product_queries_updated_at ON product_queries;
